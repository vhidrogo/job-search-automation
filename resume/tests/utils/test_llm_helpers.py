...
class TestParseJsonResponse:
    ...
    def test_parses_plain_json(self) -> None:
        """Validates parsing of plain JSON text."""
        json_text = json.dumps(self.VALID_JSON)
        
        result = parse_json_response(json_text)
        
        assert result == self.VALID_JSON
    
    def test_parses_json_with_code_blocks(self) -> None:
        """Validates parsing of JSON wrapped in markdown code blocks."""
    ...
    def test_parses_json_with_extra_whitespace(self) -> None:
        """Validates parsing of JSON with leading/trailing whitespace."""
        json_text = f"\n\n  {json.dumps(self.VALID_JSON)}  \n\n"
    ...
    def test_raises_error_for_truncated_output(self) -> None:
        """Ensures ValueError is raised for incomplete JSON (missing closing brace)."""
    ...
    def test_handles_nested_json(self) -> None:
        """Validates parsing of deeply nested JSON structures."""
